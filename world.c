...
================
*/
void SV_HullForEntity (edict_t *ent, int *firstbrush, int *numbrushes)
{
	model_t		*model;
	vec3_t		size;
...
// decide which clipping hull to use, based on the size
	...
	{	// explicit hulls in the BSP model
		...
		*firstbrush = model->firstmodelbrush;
		*numbrushes = model->nummodelbrushes;
...
// calculate an offset value to center the origin
	...
	{	// create a temp hull from bounding box sizes
		...
		*firstbrush = CM_BrushForBox(ent->v.mins, ent->v.maxs);
		*numbrushes = 1;
	}
...
PENTA: Changes for q3bsp support...
Eventually offsets and rotates begin/end points of the move and clips it to the entity's brushes
(a box for not brush ents)
==================
*/
...
// get the brushes for this entity
	SV_HullForEntity(ent,&firstbrush,&numbrushes);
